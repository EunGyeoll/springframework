                  ...
                  <div class="card-body">
                     <form class="m-2" method="post" action="login" >
                        <div class="form-group mb-2">
                            ...
                            <div> <!-- 에러메시지를 출력하라는 태그 -->
                            <input type="text" class="form-control" id="mid" name="mid" value="${ch04LoginForm.mid}">  <!-- $붙은 건 값을 넣겠다는뜻 -->
                            <div class= "text-danger" style ="font-size: 0.7rem"><form:errors path="ch04LoginForm.mid"/></div> <!-- 에러메시지를 갖고 옴. path는 에러메세지 경로 지정 -->
                        </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class = "text-danger"  style ="font-size: 0.7rem"><form:errors path="ch
                            04LoginForm.mpassword"/></div>  <!-- 에러메시지를 출력하라는 태그 -->
                        </div> 
